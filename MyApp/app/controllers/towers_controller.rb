class TowersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tower.save
        format.html { redirect_to @tower, notice: 'Torre Creada.' }
  ...
  def update
    respond_to do |format|
      if @tower.update(tower_params)
        format.html { redirect_to @tower, notice: 'Torre Actualizada.' }
  ...
  def destroy
    @tower.destroy
    respond_to do |format|
      format.html { redirect_to towers_url, notice: 'Torre Eliminada.' }
  ...
  private
    ...
    def tower_params
      params.require(:tower).permit(:name, :watchman)
    end
end
