...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { color: @producto.color, costo: @producto.costo, descripcion: @producto.descripcion, marca: @producto.marca, referencia: @producto.referencia, talla: @producto.talla }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { color: @producto.color, costo: @producto.costo, descripcion: @producto.descripcion, marca: @producto.marca, referencia: @producto.referencia, talla: @producto.talla }
    assert_redirected_to producto_path(assigns(:producto))
  end
